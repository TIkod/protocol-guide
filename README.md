...
Репозиторий разработан и сформирован **[TICode](https://ticode.online/)** — платформой для обучения программированию.

Материалы предназначены для студентов и всех, кто хочет разобраться в асинхронном программировании на Python с нуля до уверенного уровня.

Следите за новыми материалами на [ticode.online](https://ticode.online/)
